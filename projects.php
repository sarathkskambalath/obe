...
<head>
    ...
    <meta name="description" content="salahh.com ">
    <meta name="author" content="Salahh Projects Showcase">
    <meta name="keywords" content="salahh.com ">
                    ...
                    <div class="container-fluid">
                        <div class="header-mobile__bar-inner">
                            <a class="logo" href="index.html">
                                <img src="images/icon/logo-black.png" alt="Salahh" />
                            </a>
       ...
       <!-- MAIN-->
        <main id="main">
            <section id="fs-container">
                <div class="media-project-hover" data-background="images/bg-project-01.jpg">
                    <div class="bg-overlay"></div>
                    <div class="media__body">
                        <h5 class="media__sub-title title-sub">Projects</h5>
                        <h3 class="media__title">
                            <a href="buildings.php">Buildings</a>
                        </h3>
                        <a class="link" href="buildings.php">see project
                            <i class="zmdi zmdi-arrow-right"></i>
                        </a>
                    </div>
                    <span class="media__number">01</span>
                </div>
                <div class="media-project-hover" data-background="images/bg-project-02.jpg">
                    <div class="bg-overlay"></div>
                    <div class="media__body">
                        <h5 class="media__sub-title title-sub">Projects</h5>
                        <h3 class="media__title">
                        ...
                        <a class="link" href="project-grid-full.html">see project
                            <i class="zmdi zmdi-arrow-right"></i>
                        </a>
                    </div>
                    <span class="media__number">02</span>
                </div>
                <div class="media-project-hover" data-background="images/bg-project-03.jpg">
                    <div class="bg-overlay"></div>
                    <div class="media__body">
                        <h5 class="media__sub-title title-sub">Projects</h5>
                        <h3 class="media__title">
                            <a href="villas-and-mosque.php">Villas & Mosque</a>
                        </h3>
                        <a class="link" href="project-grid-full.html">see project
                            <i class="zmdi zmdi-arrow-right"></i>
                        </a>
                ...
                <div class="media-project-hover" data-background="images/bg-project-04.jpg">
                    <div class="bg-overlay"></div>
                    <div class="media__body">
                        <h5 class="media__sub-title title-sub">Videos</h5>
                        <h3 class="media__title">
